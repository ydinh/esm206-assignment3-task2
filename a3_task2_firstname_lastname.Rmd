...
Run the code below to see how the `lubridate::ymd()` function (and variants) can convert a number to a date. **NOTE**: I use `ymd()` because the order of the elements is in *Year* - *Month* - *Day*. 
...
In the code chunk below, use `ymd()` to convert "19010316" to a date: 
...
- Press Commit, add commit message
- 
